...
class IEDataset(Dataset):
    def __init__(self, path, max_length=150, gpu=False, ignore_title=False,
...
class IEDatasetEval(object):
    def __init__(self, path, max_length=180, gpu=False, input_format='txt',
                 language='english'):
        self.path = path
        self.gpu = gpu
        self.max_length = max_length
    ...
    def load_data(self):
        ...
        if self.input_format == 'txt':
            ...
            doc_tokens, doc_id, self.pieces = read_json(self.path)
