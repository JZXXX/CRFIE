...
def load_model(model_path, device=0, gpu=False, beam_size=20):
...
def evaluate(model_path, test_file, device=0, gpu=False,beam_size=20):
    # set gpu device
    if gpu:
...
test_scores = evaluate(model_path=args.model_path,
